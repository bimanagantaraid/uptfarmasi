                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>1.</td>
                                    <td>Stok Aktif <small>(sisa stok sebelumnya + stok penerimaan bulan dipilih)</small></td>
                                ...
                                <tr>
                                    <td>3.</td>
                                    <td>Total Mutasi <small>(Bulan Dipilih)</small></td>
                                    <td><span class="badge bg-danger" id="PemakianSekarang"></span></td>
                                </tr>
                                <tr>
                                    <td>4.</td>
                                    <td>Sisa Stok</td>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.keterangan === 'requiredfalse') {
                        ...
                        $('#PemakianSekarang').text((data.PemakianSekarang != null) ? data.PemakianSekarang : 0);
